...
var ray = cm_cast_ray(LEVEL_COLMESH, cm_ray(x, y, 1000, x, y, -100));
...
colFunc = function()
{
	...
	cm_remove(LEVEL_COLMESH, shape);						//"shape" is oCoin's shape variable. Remove it from the ColMesh
...
shape = cm_add(LEVEL_COLMESH, cm_sphere(x, y, z, radius, CM_GROUP_TRIGGER));
